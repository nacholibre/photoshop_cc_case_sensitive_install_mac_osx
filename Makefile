PHOTOSHOP_INSTALLER_PATH=/Volumes/Photoshop\ Installer/Photoshop\ Installer.app/Contents/MacOS/Install
...
ifneq ($(shell whoami),root)
	...
	DYLD_INSERT_LIBRARIES=$(shell pwd)/lib_override_volume_sensitivity_check.dylib $(PHOTOSHOP_INSTALLER_PATH)
endif
